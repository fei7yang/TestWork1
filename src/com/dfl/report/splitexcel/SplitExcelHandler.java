...
public class SplitExcelHandler extends AbstractHandler {
	...
	private SplitExcelOperation splitExcelOperation;
	private Shell shell;
	...
	protected void execute() throws TCException {
		...
		// 下载VBS脚本
		File scriptFile = Util.getRCPPluginInsideFile("SplitExcel.vbs");
			...
			public void run() {
				IRunnableWithProgress runnable = new IRunnableWithProgress() {
					public void run(IProgressMonitor monitor) {
						...
						splitExcelOperation = new SplitExcelOperation(session, documentList, vbsFilePath, savefolder);

						try {
							splitExcelOperation.executeOperation();
						} catch (Exception e) {
							// TODO Auto-generated catch block
							monitor.done();
							e.printStackTrace();
				...
				try {
					...
					String resultmessage = splitExcelOperation.getResultMessage();
	...
	private TCComponentItemRevision getLatestItemRevision(TCComponentItem item) {
		// TODO Auto-generated method stub
