...
public class CheckListHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		...
		if(rule == null || rule.size()<1) {
			MessageBox.post("错误：首选项未定义DFL9_Selection_test_phase，请联系系统管理员！", "错误",
					MessageBox.INFORMATION);
			return null;
		}
	...
	protected void openDialog() {
		...
		CheckListAction action = new CheckListAction(app, null, savefolder, aifComponents, session,rule);
