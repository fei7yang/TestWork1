...
public class DefectsListHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		...
		if (inputStream == null) {
			MessageBox.post("错误：没有找到生产要件不具合一元表模板，请联系系统管理员在TC中添加模板(名称为：DFL_Template_DefectsCheckList)", "错误",
	...
	protected void openDialog() {
		...
		DefectsListAction action = new DefectsListAction(app, null, savefolder, aifComponents, session);
