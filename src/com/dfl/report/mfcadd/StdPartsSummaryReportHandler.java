...
public class StdPartsSummaryReportHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		...
		if(!downerror) {
			MFCUtility.errorMassges("错误：没有找到车型标准件信息汇总表的模板，请先在TC中添加模板(名称为：DFL_Template_StandardStatistics！" );
			return null;
		}
	...
	protected void openDialog() {
		...
		StdPartsSummaryReportAction action = new StdPartsSummaryReportAction(this.bopLine, savefolder);
