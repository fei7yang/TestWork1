...
public class DATUMSummaryReportHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent arg0) throws ExecutionException {
		...
		if(!downerror) {
			MFCUtility.errorMassges("错误：没有找到DATUM做成统计信息汇总表的模板，请先在TC中添加模板(名称为：DFL_Template_DatumStatistics)，请联系系统管理员！" );
			return null;
		}
	...
	protected void openDialog() {
		...
		DATUMSummaryReportAction action = new DATUMSummaryReportAction(this.bopLine, savefolder);
